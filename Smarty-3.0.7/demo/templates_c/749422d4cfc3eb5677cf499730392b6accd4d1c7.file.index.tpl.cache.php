<?php /* Smarty version Smarty-3.0.7, created on 2011-05-09 12:11:33
         compiled from ".\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41764dc7bdd5aabfa3-60697985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '41764dc7bdd5aabfa3-60697985',
  'function' => 
  array (
  ),
  'has_nocache_code' => true,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include 'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include 'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\function.html_options.php';
?><?php echo '/*%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'C:\xampp\htdocs\php2011\Smarty-3.0.7\libs\plugins\modifier.date_format.php\';
?>/*/%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/';?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/<?php echo ((mb_detect_encoding($_smarty_tpl->getVariable(\'Name\')->value, \'UTF-8, ISO-8859-1\') === \'UTF-8\') ? mb_strtoupper($_smarty_tpl->getVariable(\'Name\')->value,SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable(\'Name\')->value));?>
/*/%%SmartyNocache:41764dc7bdd5aabfa3-60697985%%*/';?></b>
