...
//require_once "../../phpMyAdmin/setup/config.php"; //This file contains the credentials for our connection. Remember to put it outside the scope of our virtual host (so above the htdocs folder when on localhost, or above the public_html folder when on internet hosting) and provide the correct path.
